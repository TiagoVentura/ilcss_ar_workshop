...
`Tidyverse` is a family of R packages developed in an integrated way. These packages share the same underlying design philosophy, grammar and data structures.
...
The logics structuring the `dplyr` functions is  simple: its functions do exactly what their names describe (**verb based language**). These are the most useful functions: 
...
All of these functions follow the same characteristics:
